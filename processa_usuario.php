...
<body>
                ...
                <div class="form-data">
                    <div class="row form-group">
                        <div class="col-sm-4">
                            ...
                            <input name="con_nome" type="text" class="form-control blockenter" id="con_nome"
                                style="text-transform:uppercase;" value="<?php echo $_POST['con_nome'] ?>" disabled />
                        </div>
                        <div class="col-sm-4">
                    ...
                    <div class="row form-group">
                        <div class="col-sm-4">
                            ...
                            <select name="con_uf" id="con_uf" data-reqmsg="Selecione seu estado"
                                class="form-control blockenter" disabled>
                                <option value="<?php echo $_POST['con_uf'] ?>" selected disabled>
                                    <?php echo $_POST['con_uf'] ?>
                                </option>
    ...
    <form role="form" action="processa_usuario.php" id="MyForm" method="post" enctype="multipart/form-data"
        name="MyForm">
        <div class="wrapper wrapper-content animated fadeInRight">
                ...
                <div class="form-data" id="item_0">
                    <div class="row form-group">
                        ...
                        <div class="col-sm-1">
                            ...
                            <input name="ped_preco_uni_0" type="text" class="form-control blockenter" id="ped_preco_uni_0"
                                required />
                        </div>
                        <div class="col-sm-1">
                            <label class="control-label" for="ped_total_0">Total</label>
                            <input name="ped_total_0" type="text" class="form-control blockenter" id="ped_total_0"
                                readonly />
                        </div>
                        <div class="col-sm-1 ">
            ...
            <div class="form-data" id="item_${qtdItems}">
                <div class="row form-group">
                    ...
                    <div class="col-sm-1">
                        ...
                        <input name="ped_preco_uni_${qtdItems}" type="text" class="form-control blockenter" id="ped_preco_uni_${qtdItems}" required />
                    </div>
                    <div class="col-sm-1">
                        <label class="control-label" for="ped_total_${qtdItems}">Total</label>
                        <input name="ped_total_${qtdItems}" type="text" class="form-control blockenter" id="ped_total_${qtdItems}" readonly />
                    </div>
                    <div class="col-sm-1 ">
                        <span onclick="addItem()" class="btn btn-success btn-duplicate" style="margin-top: 32px"><i
                                class="bi bi-plus"></i></span>
